...
export declare const generatedSchema: {
  ...
  [SchemaUnionsKey]: {
    ...
    ContentNode: ['MediaItem', 'Page', 'Post', 'Testimonial'];
    HierarchicalContentNode: ['MediaItem', 'Page'];
    NodeWithAuthor: ['MediaItem', 'Page', 'Post', 'Testimonial'];
    NodeWithComments: ['MediaItem', 'Page', 'Post'];
    NodeWithTemplate: ['MediaItem', 'Page', 'Post', 'Testimonial'];
    NodeWithTitle: ['MediaItem', 'Page', 'Post', 'Testimonial'];
...
export interface ContentNode {
  __typename?: 'MediaItem' | 'Page' | 'Post' | 'Testimonial';
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
